...
#### Chromo analysis
It's observable that the scale used is C,B,A,B,F,D# and D, because the pitch magnitudes are concentrated on horizontal axis. The spacing in the pitches is very similar to the piano part in "Tell me it's not a dream" and in fact the track is mainly accompanied by the piano. This track's chromagram has no o    bvious patterns, the magnitudes are all over the place. Hinting towards a high tempo track. 
